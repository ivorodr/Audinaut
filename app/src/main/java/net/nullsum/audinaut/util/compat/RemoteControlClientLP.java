package net.nullsum.audinaut.util.compat;
...
import net.nullsum.audinaut.util.SilentServiceTask;
...
public class RemoteControlClientLP extends RemoteControlClientBase {
    ...
    public void updateMetadata(Context context, Entry currentSong) {
        if(currentSong != null && imageLoader != null) {
            SilentBackgroundTask<Void> loadImageTask = imageLoader.loadImage(context, this, currentSong, false);
            if (loadImageTask != null) {
                loadImageTask.setOnCompletionListener(() -> {
                    try {
    ...
    private void playMusicDirectory(final String dirId, final boolean shuffle, final boolean append) {
        new SilentServiceTask<Void>(downloadService) {
            ...
            protected Void doInBackground(MusicService musicService) throws Throwable {
                ...
                playSongs(playEntries, shuffle, append);
    ...
    private class EventCallback extends MediaSessionCompat.Callback {
        ...
        public void onPlayFromMediaId (String mediaId, Bundle extras) {
            ...
            // Enqueue an entire directory when selecting a song
