...
import net.nullsum.audinaut.util.compat.RemoteControlClientLP;
...
public class AutoMediaBrowserService extends MediaBrowserServiceCompat {
    ...
    private void getLibrary(final Result<List<MediaBrowserCompat.MediaItem>> result, Boolean tagBrowsing) {
